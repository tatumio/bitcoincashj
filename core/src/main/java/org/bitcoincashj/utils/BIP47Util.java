...
import org.bitcoincashj.core.bip47.BIP47PaymentAddress;
...
public class BIP47Util {
    ...
    public static FeeCalculation calculateFee(org.bitcoincashj.wallet.Wallet vWallet, SendRequest req, Coin value, List<TransactionOutput> candidates) throws InsufficientMoneyException {
     ...
     */
    static void signTransaction(org.bitcoincashj.wallet.Wallet vWallet, SendRequest req, byte[] pubKey, BIP47PaymentCode myBIP47PaymentCode) {
    ...
    private static int estimateBytesForSigning(org.bitcoincashj.wallet.Wallet vWallet, CoinSelection selection) {
        int size = 0;
        for (TransactionOutput output : selection.gathered) {
            try {
