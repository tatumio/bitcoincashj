 ...
 * a wallet app, look at {@link SlpPaymentSession} for a higher level API that should simplify working with the protocol.</p>
 *
 ...
 */
public class SlpPaymentProtocol {

    // MIME types as defined in BIP71.
    public static final String MIMETYPE_PAYMENTREQUEST = "application/simpleledger-paymentrequest";
    public static final String MIMETYPE_PAYMENT = "application/simpleledger-payment";
    public static final String MIMETYPE_PAYMENTACK = "application/simpleledger-paymentack";
     ...
     */
    public static SlpPaymentSession parsePaymentRequest(Protos.PaymentRequest paymentRequest)
            throws PaymentProtocolException {
        return new SlpPaymentSession(paymentRequest, false, null);
    }
