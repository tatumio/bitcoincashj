...
import static org.bitcoincashj.core.Transaction.SERIALIZE_TRANSACTION_NO_WITNESS;
...
public class ScriptTest {
    ...
    public void testScriptPubKey() throws Exception {
        ...
        Address toAddr = Address.fromP2PKHHash(TESTNET, ScriptPattern.extractHashFromP2PKH(pubkey));
    ...
    public void getToAddress() throws Exception {
        ...
        Address scriptAddress = Address.fromP2SHHash(TESTNET,
